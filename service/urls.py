...
from .views import BookingView, WorkerList, ServiceList, UserStatistics ,CustomerBookingList ,WorkerBookingRequestList, BookingStatusView, WorkerAvailabilityView
